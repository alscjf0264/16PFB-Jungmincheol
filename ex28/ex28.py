...
print (" 7. False and 0!=0 = %s" % str(True and (1 == 1))))
print(" 8. Ture or 1==1 = %s" % str(False and (0 ! = 0)))
...
print ("13. not(True and False) = %s" % (not(True amd False)))
...
print ("extra 2. 1 and 1 = = %s" %s % str(1 and 1))
print ("extra 3. False and 1 = = %s" % str(False and 1))
print ("extra 4. Ture and 1 = = %s" % str(Ture and 1))
